...
const Icons = { metaMask: MetamaskIcon, walletConnect: WalletConnectIcon, coinbaseWallet: CoinbaseIcon }
      ...
      <div className=" py-2">
        {connectors.map((connector) => (
          <div key={connector.id} className="mt-4 relative">
            ...
            >
              <Image src={Icons[connector.id]} alt={connector.name} width={24} height={24} />
              {connector.name}
